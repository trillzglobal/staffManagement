...
@section('content')
                ...
                <div class="py-2 shadow card border-left-primary h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="mr-2 col">
                                <div class="">
                                    <h4 class="font-weight-bolder">{{__('Workspace')}}</h4>
                                    <p>{{ $workspace->name }}</p>
                                </div>
                ...
                <div class="py-2 shadow card border-left-primary h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="mr-2 col">
                                <div class="">
                                    <h4 class="font-weight-bolder">{{__('Project')}}</h4>
                                    <p>{{ $pro->name }}</p>
                                </div>
                ...
                <div class="py-2 shadow card border-left-primary h-100">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="mr-2 col">
                                <div class="">
                                    <h4 class="font-weight-bolder">{{__('Assigned User')}}</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="taskform" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="role">{{__('Select Priority')}}</label>
                        ...
                        <div class="form-group">
                            <label for="">{{__('Assign To')}}</label>
                            <div class="checkbox">

                                @foreach ($projects->users as $user)

                                    <label><input type="checkbox" name="user_id[]" value="{{ $user->id }}">
                                        {{ $user->name }}</label>
    ...
    <div id="delete_task_modal" class="modal fade">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{__('Delete Task')}}</h4>
                    <button class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="mess"></div>
                    ...
                    <div class="form-group">
                        ...
                        <h5>{{__('Are You Sure To Delete This Task')}}? </h5>
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer text-right">
                    ...
                    <button type="submit" class="btn btn-danger" id="deletetask">{{__('Delete')}}</button>
