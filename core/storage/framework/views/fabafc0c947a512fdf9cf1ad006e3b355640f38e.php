...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
            ...
            <div class="card col-md-12">
                <div class="card-header">
                    <a class="btn btn-sm btn-primary" data-toggle="modal" href="#add_asset_modal"><?php echo e(__('Add new Asset')); ?></a>
                </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php echo e(__('Add Asset Type')); ?></h4>
    ...
    <div id="delete_asset_modal" class="modal fade">
        <div class="modal-dialog">
            <form id="ss" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php echo e(__('Delete Equipment')); ?></h4>
                        <button class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
                        <div class="mess"></div>
    ...
    <div id="edit_asset_modal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo e(__('Edit Asset Type')); ?></h4>
                    <button class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="mess"></div>
                    <form method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <label for=""><?php echo e(__('Asset Type Name')); ?></label>
                            <input type="hidden" name="assetTypeId">
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        $(document).on('click', '#addAssetType', function(e) {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.assetTypeTable')); ?>",
                method: 'POST',
                data: {
        ...
        var tableLoad = $('#assetTypeDT').DataTable({
            ajax: "<?php echo e(route('admin.asset.get')); ?>",
            columns: [{
                    "data": "id"
                },
                {
        ...
        $(document).on('click', '#deleteAssetType', function(e) {
            ...
            let url = "<?php echo e(route('admin.delete-assetType',':id')); ?>";
        ...
        $(document).on('click', 'a#editAssetTypeModal', function(e) {
            ...
            let url = "<?php echo e(route('admin.ediit-assetType',':id')); ?>";
            url = url.replace(':id', assetTypeID);
        ...
        $(document).on('click', '#editAssetType', function(e) {
            ...
            let url = "<?php echo e(route('admin.update-assetType',':id')); ?>";
            url = url.replace(':id', assetTypeID);
...
<?php echo $__env->make('admin.admin-layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/Users/M1CH43L/Desktop/AirvendApplication/hrm/MainFile/core/resources/views/admin/Asset/assetType.blade.php ENDPATH**/ ?>